...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:se="http://www.opengis.net/se" xmlns:xlink="http://www.w3.org/1999/xlink" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="1.1.0" xmlns:ogc="http://www.opengis.net/ogc">
  <NamedLayer>
    <se:Name>77.25 - przeznaczenie terenu</se:Name>
    <UserStyle>
      <se:Name>77.25 - przeznaczenie terenu</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>U/P</se:Name>
          <se:Description>
            <se:Title>U/P</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>hiluks</ogc:PropertyName>
              <ogc:Literal>U/P</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:PolygonSymbolizer>
            <se:Fill>
              <se:SvgParameter name="fill">#f26241</se:SvgParameter>
            </se:Fill>
            <se:Stroke>
              ...
              <se:GraphicFill>
                <se:Graphic>
                  <se:Mark>
                    ...
                    <se:Stroke>
                      <se:SvgParameter name="stroke">#9164af</se:SvgParameter>
                    </se:Stroke>
                  </se:Mark>
                </se:Graphic>
              </se:GraphicFill>
        ...
        <se:Rule>
          ...
          <se:TextSymbolizer>
            <se:Label>
              <ogc:PropertyName>przeznacze</ogc:PropertyName>
            </se:Label>
            <se:Font>
